...
function ProjectCard({ project, index }) {
    return (
        ...
        >
            {/* Card header */}
            <div className={`relative h-32 bg-gradient-to-br ${project.grad}
                ...
                <span className={`absolute top-3 left-3 px-2.5 py-0.5 rounded-full
                    text-[10px] font-black tracking-wide ${project.tagColor}`}>
                    {project.difficulty}
                </span>
...
function Projects() {
    ...
    const { page, filters, projects } = data;
    ...
    const filtered = useMemo(() => {
        return projects.filter((p) => {
            ...
            const matchDifficulty = difficulty === "All Levels" || p.difficulty === difficulty;
            ...
            <div ref={topRef} className="max-w-6xl mx-auto px-6 py-10">
                ...
                {paginated.length > 0 ? (
                    ...
                    <div className="flex flex-col items-center justify-center py-24 text-center">
                        ...
                        <h3 className="font-black text-lg mb-2">No projects found</h3>
